        ...
        <div className={styles.content__main__body__bigBox}>
          <RichText
            ...
            renderers={{
              ...
              h2: ({ children }) => (
                <h2
                  id={children.props.content["0"].text}
                  className={styles.body__h2}
                >
                  {children}
                </h2>
              ),
