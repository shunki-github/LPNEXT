...
export default function topComponent(topBlog) {
  ...
  return (
    <div className={styles["article--top"]}>
      <Link
        ...
        >
            <div>
            <Image src={topBlog.ogpImage.url} alt={`${topBlog.title} topImage`} layout="responsive"
                width="100%"
                height="60%"/>
            <div className={styles["article__content"]}>
                ...
                <p className={styles["article__content__title--top"]}>{topBlog.title}</p>
